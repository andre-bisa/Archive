...
public class MyCalendarTest {
	CalendarController myCal;

	@Before
	public void setUp() {
		Persister<AppointmentCollection> persister = new MockCalendarPersister();
		myCal = new MyCalendar(persister);
	}

	@Test
	public void testAdd() {
		LocalDateTime from = LocalDateTime.of(2012, Month.MARCH, 10, 12, 30, 0);
		LocalDateTime to = LocalDateTime.of(2012, Month.MARCH, 10, 15, 30, 0);
		Appointment app = new Appointment("Compleanno", from, to);
		assertTrue(myCal.add(app));
	}
