...
Public Class situazione_finanziaria

    Public y_riga As Integer = 0
    Public x1_finale, y1_finale, x2_finale, y2_finale As Integer

    Sub linea_sit(x1 As Integer, y1 As Integer, x2 As Integer, y2 As Integer, intensita As Integer)
        Dim pen As New Pen(Color.Black, intensita)
        Me.CreateGraphics.DrawLine(pen, x1, y1, x2, y2)
    End Sub

    Private Sub situazione_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Principale.Enabled = 1
    End Sub

    Private Sub situazione_Shown(sender As Object, e As System.EventArgs) Handles Me.Shown
        tmrdisegna.Start()
    End Sub

    Private Sub tmrdisegna_Tick(sender As System.Object, e As System.EventArgs) Handles tmrdisegna.Tick
        Me.linea_sit(10, 50, 410, 50, 2)
        Me.linea_sit(200, 50, 200, 350, 2)

        If (y_riga > 0) Then
            Me.linea_sit(200, 50, 200, y_riga + 50, 2)
            tmranimazione.Start()
        End If
    ...
    Private Sub tmrriga_finale_Tick(sender As System.Object, e As System.EventArgs) Handles tmrriga_finale.Tick
        Me.linea_sit(x1_finale, y1_finale, x2_finale, y2_finale, 3)
        tmrriga_finale.Stop()
    End Sub
